...
const RandomCard = () => {
  return (
    <div className=' bg-[#ab8e66c2] text-[#fff] tracking-wide gap-[2rem]  rounded-[10px] px-[1rem] py-[2rem] shadow-[#444444] shadow-md  h-[250px] flex  justify-center w-[100%] items-center  ' >
