...
const GucciCardM = () => {
    return (
        <div  animateIn='fadeIn' animateOut='fadeOut'  className=' GucciT flex gap-2 shadow h-[10rem] w-[100%] bg-[#333333] ' >
    
            <div  className=' gucci  w-[10rem] flex flex-col gap-3 h-[10rem] justify-center ' >
