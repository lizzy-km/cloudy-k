...
const ChanelCardM = () => {
  return (
    <div  animateIn='fadeIn' animateOut='fadeOut'  className=' rounded-[10px] chanel flex gap-2 shadow h-[10rem] w-[100%] bg-[#333333] ' >

        <div  className=' chanelS rounded-l-[10px]  w-[20%] flex flex-col gap-3 h-[100%] justify-center ' >
