...
//    logo === 'flex ml-[400px]  justify-center items-center text-2xl font-semibold border-2 border-black h-[2rem]' &&         setLogo('flex   justify-center items-center text-2xl font-semibold border-2 border-[#fff] border-black h-[2rem]')
  ...
  return (
    <div className=' text-[#121212] nav overflow-hidden w-[100%] relative h-[4rem] flex justify-between px-[5rem] py-[2rem] bg-transparent items-center ' >
      ...
      <div className={menu} >
        <div className='hover:border-b-2 text-[#fff] w-[2rem] h-[2rem] flex justify-center items-center  ' >
            <BsSearch onClick={search} className='text-xl cursor-pointer  ' />
        </div>
        <Link to={'/'}  className='hover:border-b-2 w-[2rem] text-[#fff] h-[2rem] flex justify-center items-center '>
            <IoCartOutline className='text-2xl  cursor-pointer ' />
        </Link>

        <Link to={'/'}  className='hover:border-b-2 text-[#fff] flex justify-center items-center w-[2rem] h-[2rem] '>
