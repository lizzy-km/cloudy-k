  ...
  return (
    <div className='mid top-[0%] overflow-y-hidden  flex flex-col justify-center items-center gap-0  h-auto w-[100%] ' >
                ...
                <div className={main} >
                    ...
                    <svg className=' brand ' xmlns="http://www.w3.org/2000/svg" height="3rem" width="8em" version="1.0" viewBox="-45.43695 -48.48325 393.7869 290.8995">
...
}
{
    isMobile &&                    <RandomCardM/>
                    ...
                    <div className=' w-[100%] flex flex-col justify-center items-center  text-center gap-4 ' >
                    <svg className='brand' xmlns="http://www.w3.org/2000/svg" height="3rem" width="6rem" viewBox="-18.3195 -31.83875 158.769 191.0325">
...
/>
                    ...
                    <svg className='brand p-[.3rem] ' xmlns="http://www.w3.org/2000/svg" width="4rem" height="2rem" viewBox="0 0 108 18" fill="#121212">
